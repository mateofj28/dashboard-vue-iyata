          ...
          <div class="max-w-4xl mx-auto">
              ...
              >
                <div class="flex items-center space-x-4 mb-4">
                  <div class="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
                    <component :is="step.icon" :size="24" class="text-blue-600" />
                  </div>
            ...
            <div class="bg-white rounded-lg border border-gray-200 overflow-hidden mb-8">
              <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-xl font-semibold text-gray-900">Recommended Learning Paths</h2>
                <p class="text-gray-600 text-sm mt-1">Choose a path that matches your role and interests</p>
              </div>
              <div class="p-6">
                  ...
                  >
                    <div class="flex items-center space-x-3 mb-3">
                      ...
                      <div>
                        ...
                        <p class="text-xs text-gray-500">{{ path.duration }} • {{ path.courses }} courses</p>
                      </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                      <div class="flex items-center space-x-2">
                        ...
                        <span class="text-xs text-gray-500">{{ path.progress }}%</span>
                      </div>
            ...
            <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
              <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-xl font-semibold text-gray-900">Help & Resources</h2>
              </div>
              <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div 
                    ...
                    :key="resource.id"
                    class="text-center p-4 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer"
                  >
                    <div class="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-3">
                      <component :is="resource.icon" :size="24" class="text-gray-600" />
                    </div>
